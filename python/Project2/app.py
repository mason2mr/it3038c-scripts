#Cited Source For Code: https://www.fullstackpython.com/flask-templating-render-template-examples.htmlfrom flask import Flask,render_template,request
import time
...
print("Myron Today's Date And Time is Currently:") # Displays my personalized script
